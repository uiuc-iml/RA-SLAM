...
__device__ __host__ MultiClsSemantics::MultiClsSemantics() {
    uniform_init();
  }
...
__device__ void MultiClsSemantics::update(const float* prob_map, const int img_idx, const int class_offset) {
