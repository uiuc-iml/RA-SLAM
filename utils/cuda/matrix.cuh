...
class Matrix3 {
 ...
 public:
  ...
  __device__ __host__ Matrix3<T>(const T& a00, const T& a01, const T& a02, const T& a10,
                                 const T& a11, const T& a12, const T& a20, const T& a21,
                                 const T& a22)
      : m00(a00), m01(a01), m02(a02), m10(a10), m11(a11), m12(a12), m20(a20), m21(a21), m22(a22) {}
  ...
  __device__ __host__ inline Matrix3<Tout> cast() const {
    return Matrix3<Tout>(static_cast<Tout>(m00), static_cast<Tout>(m01), static_cast<Tout>(m02),
  ...
  __device__ __host__ inline Matrix3<T> operator-() const { return (T)0 - *this; }
  ...
  __device__ __host__ inline bool operator==(const Matrix3<T>& rhs) const {
    return m00 == rhs.m00 && m01 == rhs.m01 && m02 == rhs.m02 && m10 == rhs.m10 && m11 == rhs.m11 &&
           m12 == rhs.m12 && m20 == rhs.m20 && m21 == rhs.m21 && m22 == rhs.m22;
  }
...
class Matrix4 {
 ...
 public:
  ...
  __device__ __host__ inline Matrix4<Tout> cast() const {
    return Matrix4<Tout>(static_cast<Tout>(m00), static_cast<Tout>(m01), static_cast<Tout>(m02),
  ...
  __device__ __host__ inline Matrix4<T> operator-() const { return (T)0 - *this; }
  ...
  __device__ __host__ inline bool operator==(const Matrix4<T>& rhs) const {
    return m00 == rhs.m00 && m01 == rhs.m01 && m02 == rhs.m02 && m03 == rhs.m03 && m10 == rhs.m10 &&
           m11 == rhs.m11 && m12 == rhs.m12 && m13 == rhs.m13 && m20 == rhs.m20 && m21 == rhs.m21 &&
           m22 == rhs.m22 && m23 == rhs.m23 && m30 == rhs.m30 && m31 == rhs.m31 && m32 == rhs.m32 &&
           m33 == rhs.m33;
  }
